...
class custom_metadata_manager {
	...
	var $_cloneable_field_types = array( 'text', 'textarea', 'upload', 'password', 'datepicker');
	...
	function admin_init() {
		...
		define( 'CUSTOM_METADATA_MANAGER_URL' , get_bloginfo('template_url').'/functions/custom-meta/' );
	...
	/****************************************************
		Instead of wp get_metadata(), this function will keep meta data array order
	*****************************************************/
	function _my_get_metadata($object_type, $object_id, $field_slug, $single){
		global $wpdb;
	...
	function _get_field_value( $field_slug, $field, $object_type, $object_id ) {
		...
		$value = $this->_my_get_metadata( $object_type, $object_id, $field_slug, false );
		...
		<div class="custom-metadata-field <?php echo $field->field_type ?>">
			...
			// make sure $value is an array
				...
				<div class="<?php echo $field_slug ?> cloneable" id="<?php echo $field_slug ?>-<?php echo $count;?>">
					...
					<?php if (isset($field->multiple) && $field->multiple) : ?>
						<div class="drag-order"></div>
					<?php endif;?>

					<?php switch ($field->field_type) :
							case 'text': ?>
							<input type="text" <?php if($field->multilanguage) echo 'class="multilanguage-input"'; ?> id="<?php echo $field_slug; ?>" name="<?php echo $field_id; ?>" value="<?php echo esc_attr( $v ); ?>" <?php echo $readonly_str ?>/>
						<?php break; ?>

						<?php case 'textarea': ?>
							<textarea <?php if($field->multilanguage) echo 'class="multilanguage-input"'; ?> id="<?php echo $field_slug; ?>" name="<?php echo $field_id; ?>" <?php echo $readonly_str ?>><?php echo esc_attr($v); ?></textarea>
						<?php break; ?>
						...
						<?php case 'datepicker': ?>
							<input type="text" name="<?php echo $field_id; ?>" value="<?php echo @date('Y-m-d', $v); ?>" <?php echo $readonly_str ?>/>
						<?php break; ?>
						...
						<?php case 'upload': ?>
							<input type="text"  <?php if($field->multilanguage) echo 'class="multilanguage-input"'; ?> name="<?php echo $field_id; ?>" value="<?php echo $v; ?>" class="upload_field" <?php echo $readonly_str ?>/>
